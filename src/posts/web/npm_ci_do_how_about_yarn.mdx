---
slug: "/web/npm_ci_do_how_about_yarn"
date: "2021-12-14"
title: "npm ci란? 그렇다면 yarn은?"
thumbnail: ""
description: "npm ci에 대한 설명과 yarn에서는 어떻게 사용되어지는지 정리하였습니다."
category: 'web'
hash: ['node', 'yarn', 'npm', 'ci']
---
...
[npm Docs 링크](https://docs.npmjs.com/cli/v8/commands/npm-ci)



[yarn Docs 링크](https://yarnpkg.com/cli/install)
