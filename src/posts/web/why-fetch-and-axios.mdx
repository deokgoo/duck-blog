...
`XMLHttpRequest`을 사용하여 낡은 코드를 작성한다고 코칭을 받고 충격을 먹어 `Axios, Fetch`에 대해서 공부를 하였습니다. <br/>

## <div style="color: #FE8B44;margin-bottom:12px;">본론</div>

<h3> 1. Fetch </h3>

XMLHttpRequest API의 대체제로 간단하게 사용하는 것이 가능합니다.<br/>
...
* 모듈 설치 환경이 안되거나 프레임워크가 불안정하다 <span style="color: blue; font-weight:bold">Fetch</span>
